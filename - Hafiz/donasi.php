...
<main id="main" class="main">
  ...
  <div class="container">
    ...
    <?php $ambil = $koneksi->query("SELECT * FROM galang_donasi"); ?>
    <?php while($per_data = $ambil->fetch_assoc()){?>
      ...
      <div class="col-md-4" >
        ...
        <div class="card-body">
          ...
          <br>
          <div class="row">
            <div class="col-md-7"><a href="informasiDonasi.php?id=<?php echo $per_data['id_gd']?>" class="btn" style="background-color: #359981; color: #fff;">Donasi</a></div>
