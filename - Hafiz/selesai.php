    ...
    <main id="main" class="main">
      ...
      <div class="card text-center">
        ...
        <div class="card-body">
          ...
          <p class="card-text"><span class="bi bi-check-circle-fill "> Berhasil melakukan transfer</span></p>
          <br>
          <p class="card-text">Tanggal        : xx/xx/xxxx</p>
          <p class="card-text">Nomor Rekening : 0000000853xxxxxx</p>
          <a href="donasi.php" class="btn btn-primary">Selesai</a>
        </div>  
      </div>
