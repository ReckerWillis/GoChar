  ...
  <body>
    ...
    <main id="main" class="main">
      ...
      <div class="container"> 
        ...
        <?php $ambil = $koneksi->query("SELECT * FROM galang_donasi WHERE id_gd = '$id_gd'"); ?>
        <?php while($per_data = $ambil->fetch_assoc()){?>
          <?php $data = $per_data['id_gd']; ?>
      <?php $ambil1 = $koneksi->query ("SELECT SUM(jumlah_donasi) FROM `berdonasi` WHERE id_gd ='$data'");?>
      <?php $per_datod = $ambil1->fetch_assoc()?>

          <a href="donasi.php" class="btn"><span class="bi-box-arrow-in-left"></span></a>
          ...
          <div class="col-md-10 mx-auto" >
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-8"><p class="card-text">Rp.<?php echo $per_datod['SUM(jumlah_donasi)']?> Rp.<?php echo $per_data['target_donasi']?></p></div>
              ...
              <div class="text-center">
                <a href="jumlahDonasi.php?email=<?php echo $per_data['email']?>&&id_gd=<?php echo $per_data['id_gd']?>" class="btn btn-primary">Donasi</a>
              </div>
            </div>
            </div>
          </div>
