...
======================================================== -->
  ...
  <body>
    ...
    <main id="main" class="main">
      ...
      <div class="container">
        <a href="jumlahDonasi.php" class="btn"><span class="bi-box-arrow-in-left "></span></a>
      </div>
      ...
      <div class="card text-center">
        ...
        <div class="card-body">
          <h5 class="card-title">Rp <?php echo $nominal ?></h5>
          <p class="card-text"><span class="bi bi-bank "> Transfer Bank</span></p>
          <p class="card-text">Nomor Rekening : 0000000853101011</p>
          <a href="selesai.php" class="btn btn-primary" type="submit">Konfirmasi Pembayaran</a>
        </div>  
      </div>
...
$ambil =$koneksi ->query("SELECT * FROM galang_donasi JOIN berdonasi ON (galang_donasi.id_gd=berdonasi.id_gd)'");

  $jumlah_donasi = $_GET('jumlah_donasi');
  $total = $jumlah_donasi + $nominal;
}
?>